...
export const useAuth = () => {
    ...
    const signIn = async (data: userSignInType) => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_PUBLIC_URL}/auth/login`, data).then(res => res.data)
    ...
    const signUp = async (data: userSignUpType) => {
        try {
            const {data: authResult} = await axios.post(`${process.env.REACT_APP_PUBLIC_URL}/auth/register`, data, {
                headers: {
    ...
    const signOut = async () => {
        await axios.post(`${process.env.REACT_APP_PUBLIC_URL}/auth/sign_out`, null, {
            headers: {
